...
<body>
	<div class="container-fluid">
		<nav class="navbar">
			<h3>
				<a class="text-decoration-none text-dark"
					style="margin-left: 15px;" href="/">Back</a>
			</h3>
			<h1 class="text-dark" style="margin: 0 auto; padding: 10px;">Admin Dashboard</h1>
			<h3>
				<a class="text-decoration-none text-dark"
		...
		<div class="container align-items-center">
			...
			<div class="row d-flex justify-content-center">
				<div class="col-md-5 m-4">
					<a class="text-decoration-none text-dark" href="/admin/employees/create"><span
						class="display-5">Add Employees</span></a>
				</div>
				<div class="col-md-5 m-4">
